    ...
    return(
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
            ...
            <div>
                ...
                <div>
                    <label htmlFor="summary" className="block text-sm font-medium text-gray-700">Role Overview</label>
                    <textarea
                    id="summary"
            ...
            <div>
                <label htmlFor="tags" className="block text-sm font-medium text-gray-700">Tech Stack & Skills (use commas to separate)</label>
                <input
                    id="tags"
                    {...register('tags')}
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
